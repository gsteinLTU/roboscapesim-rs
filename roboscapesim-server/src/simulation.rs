...
impl Simulation {
    ...
    pub fn new() -> Simulation {
        Simulation {
            ...
            integration_parameters: IntegrationParameters { max_ccd_substeps: 8, max_stabilization_iterations: 8, max_velocity_friction_iterations: 16, max_velocity_iterations: 10, ..Default::default() },
