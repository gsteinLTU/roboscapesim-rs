...
impl Simulation {
    ...
    pub fn new() -> Simulation {
        Simulation {
            ...
            integration_parameters: IntegrationParameters { max_ccd_substeps: 2, max_stabilization_iterations: 6, max_velocity_friction_iterations: 10, max_velocity_iterations: 10, allowed_linear_error: 0.002, prediction_distance: 0.0015, min_island_size: 64, ..Default::default() },
