...
impl Simulation {
    ...
    pub fn new() -> Simulation {
        Simulation {
            ...
            integration_parameters: IntegrationParameters { max_ccd_substeps: 4, max_stabilization_iterations: 6, max_velocity_friction_iterations: 10, max_velocity_iterations: 10, allowed_linear_error: 0.0015, prediction_distance: 0.00175, ..Default::default() },
